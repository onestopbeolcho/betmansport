...
6. 반드시 각 경기의 상세 링크를 본문 끝에 추가하세요:
   👉 확인하기: https://scorenix.com/predictions/[match_id]?utm_source=sns&utm_medium=auto_post
...
def _generate_sns_fallback(predictions: list) -> list:
    ...
    for p in predictions:
        ...
        text = (
            ...
            f"👉 확인하기: https://scorenix.com/predictions/{match_id}?utm_source=sns&utm_medium=auto_post_fallback\n"
